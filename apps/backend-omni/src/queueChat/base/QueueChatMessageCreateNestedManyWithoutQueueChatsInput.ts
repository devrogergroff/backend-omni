...
@InputType()
class QueueChatMessageCreateNestedManyWithoutQueueChatsInput {
...
export { QueueChatMessageCreateNestedManyWithoutQueueChatsInput as QueueChatMessageCreateNestedManyWithoutQueueChatsInput };
