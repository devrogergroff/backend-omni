...
@InputType()
class QueueAnexoCreateNestedManyWithoutQueueChatMessagesInput {
...
export { QueueAnexoCreateNestedManyWithoutQueueChatMessagesInput as QueueAnexoCreateNestedManyWithoutQueueChatMessagesInput };
